...
define("lib/Fileinput", ["jquery"], function ($) {
    ...
    b.prototype = {
        ...
        pushNameFiles:  function () {
            ...
            if (g === "" || !g) {
                g = "filestyle-" + $(".bootstrap-filestyle").length;
                h.$element.attr({id: g})
            }
            ...
            h.$elementFilestyle = $('<div class="bootstrap-filestyle input-group">' + f + "</div>");
    ...
    $(function () {
        $(".filestyle").each(function () {
            var e = $(this), d = {
                input:        e.attr("data-input") !== "false",
                icon:         e.attr("data-icon") !== "false",
                buttonBefore: e.attr("data-buttonBefore") === "true",
                disabled:     e.attr("data-disabled") === "true",
                size:         e.attr("data-size"),
                buttonText:   e.attr("data-buttonText"),
                buttonName:   e.attr("data-buttonName"),
                iconName:     e.attr("data-iconName"),
                badge:        e.attr("data-badge") !== "false"
            };
            e.filestyle(d)
        })
    });
